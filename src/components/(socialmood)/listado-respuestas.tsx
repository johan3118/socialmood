...
const ListadoRespuestasTable: React.FC<ListadoRespuestasTableProps> = ({
  ...
  const [selectedResponse, setSelectedResponse] = useState<Respuestas | null>(
    null
  );
  ...
  const handleEditRespuesta = (respuestaID: string) => {
    const selected = respuestas.find(
      (respuesta) => respuesta.unique_code === respuestaID
    );
                      ...
                      <div className="flex items-center justify-center space-x-2 w-full">
                        <span
                          className={cn(
                            buttonVariants({
                              variant:
                                respuesta.perfil.red_social === "Instagram"
                                  ? "blue"
                                  : "orange",
                              size: "smBold",
                            }),
                        ...
                        >
                          <img
                            src={
                              socialIconMap[respuesta.perfil.red_social] ||
                              "/default.svg"
                            }
                    ...
                    <td className="py-4 px-3 font-bold text-left">
                      <div className="flex items-center justify-center space-x-2">
                        <DialogTrigger
                          ...
                          onClick={() =>
                            handleEditRespuesta(respuesta.unique_code)
                          }
                        >
