...
const EditResponse: React.FC<EditFormProps> = ({
  onClose,
  onUpdate,
  defaultValues,
}) => {
  ...
  async function onSubmit(values: z.infer<typeof EditResponseSchema>) {
    const res = await updateRespuesta(
      defaultValues.unique_code,
      values.respuesta
    );
    setIsPending(true);
            ...
            <div>
              ...
              <div className="flex items-center justify-center space-x-2 w-full">
                <span className="bg-white -full flex justify-start items-center rounded-lg w-full">
                  <img
                    src={
                      socialIconMap[defaultValues.red_social] || "/default.svg"
                    }
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  >
                    <img
                      src={
                        emojimap[defaultValues.subcategoria] || "/default.svg"
                      }
                      alt="Emoji Icon"
                      className="w-6 md:w-8 h-6 md:h-8 ml-2"
                    />
