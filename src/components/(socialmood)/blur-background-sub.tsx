...
const BlurredContainer: React.FC<BlurredContainerProps> = ({
  ...
  const baseStyles =
    "relative flex flex-col items-center justify-center p-6 md:p-10 max-w-full w-[90%] md:w-[400px] border border-white/80 rounded-[30px] md:rounded-[50px] z-49 drop-shadow-xl";
